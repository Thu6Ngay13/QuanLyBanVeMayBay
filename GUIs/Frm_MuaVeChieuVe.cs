...
{
    public partial class Frm_MuaVeChieuVe : Form
    {
        public Frm_MuaVeChieuVe()
        {
            InitializeComponent();
        }

        private void Frm_MuaVeChieuVe_Load(object sender, EventArgs e)
        {
            ...
            this.Lbl_SoLuongKetQua.Text = datatable.Rows.Count.ToString();
